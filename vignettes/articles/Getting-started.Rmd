...
We used the mean to aggregate all variables even though the `volume_variation` is
...
The level can go below the 0%, this means that water from a so called ['technical water reserve'](https://pt.wikipedia.org/wiki/Volume_morto), i.e. water from below the level of the usual water pipes has been used. This happened
